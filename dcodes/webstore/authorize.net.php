<?php
define('AUTHORIZENET_LOGIN_KEY', '8EzMv84s34'); // Both your API Login and Transaction Key can be found under the Setting Menu on your Merchant Interface (on your Authorize.net account).
define('AUTHORIZENET_TRANSACTION_KEY', '8X3Q8rq4bQ3K2u7J'); // instructions can be found here: http://www.authorize.net/support/merchant/Integration_Settings/Access_Settings.htm
