...
$(function () {
	$(".cv_newslist").jcarousel({
		...
		buttonNextHTML: null,
		buttonPrevHTML: null,
		vertical: true, // vertical scrolling mode
		auto: 2, // auto: auto scroll in (seconds). Set to 0 to disable auto scroll
		wrap: 'last', // wrap: wrap carousel on last image. To disable auto return, set this to null.
		itemLastOutCallback: {
